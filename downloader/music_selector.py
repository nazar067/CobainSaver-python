...
async def select_music(callback: CallbackQuery, dp: Dispatcher):
    ...
    if source == "Y":
        ...
        asyncio.create_task(process_youtube_music(callback.bot, track_url, chat_id, dp, business_connection_id))
    
    elif source == "S":
        url = "https://open.spotify.com/track/" + track_id
        asyncio.create_task(process_spotify_track(callback.bot, url, chat_id, dp, business_connection_id))
