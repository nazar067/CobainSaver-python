    ...
    async with pool.acquire() as conn:
        ...
        if existing_row:
            ...
            await conn.execute("""
                ...
                VALUES ($1, $2, $3, $4, $5)
            """, chat_id, 
                send_tiktok_music if send_tiktok_music != None else True, 
                auto_pick_yt_quality if auto_pick_yt_quality != None else True,
                send_ads if send_ads != None else True,
                datetime.utcnow() if send_ads == False else None
            )
